...
#SBATCH --output=./output/logfiles/promsparallelcut%j.out
#SBATCH --error=./output/logfiles/promsparallelcut_%j.err
...
MAIN_DIR="promoters_cpel_old_young_${WIDTH}_${DATE}"
mkdir -p "$MAIN_DIR"
...
echo "Creating ROIs"
Rscript /dcs07/afeinber/data/personal/jzhan/CPEL2/250bp.R "$WIDTH"
