...
#SBATCH --output=./output/logfiles/unfiltered_parallelcut%j.out
#SBATCH --error=./output/logfiles/unfiltered_parallelcut_%j.err
...
echo "Creating ROIs"
Rscript /dcs07/afeinber/data/personal/jzhan/CPEL2/250bpshores_unfiltered.R "$WIDTH"
