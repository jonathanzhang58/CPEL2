...
#SBATCH --job-name=gene_cut 
#SBATCH --chdir=.
#SBATCH --partition=cee,cegs2,shared
#SBATCH --mem=50G
#SBATCH --time=400:00:00
#SBATCH --output=./manual/logfiles/gene_cut%j.out
#SBATCH --error=./manual/logfiles/gene_cut%j.err
...
MAIN_DIR="gene_filter_cpel_old_young_${WIDTH}_${DATE}"
mkdir -p "$MAIN_DIR"
...
echo "Creating ROIs"
Rscript /dcs07/afeinber/data/personal/jzhan/CPEL2/scripts/partitioning/250bp.R "$WIDTH"
...
Rscript /dcs07/afeinber/data/personal/jzhan/CPEL2/scripts/ROIcut.R "$ABSOLUTE_MAIN_DIR"
