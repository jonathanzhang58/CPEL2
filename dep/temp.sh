...
#SBATCH --output=./output/logfiles/parallelcut%j.out
#SBATCH --error=./output/logfiles/parallelcut_%j.err
...
echo "Creating ROIs"
Rscript /dcs07/afeinber/data/personal/jzhan/CPEL2/250bpshores.R "$WIDTH"
